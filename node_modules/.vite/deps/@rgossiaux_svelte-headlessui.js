...
function create_else_block(ctx) {
  ...
  function switch_props(ctx2, dirty) {
    ...
    if (dirty !== void 0 && dirty & /*use, forwardEvents, $$restProps, propsWeControl, hidden, undefined*/
    220) {
...
function create_default_slot_5(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const render_changes = dirty & /*$$restProps, propsWeControl, as, slotProps, use, forwardEvents, describedby, visible*/
...
function create_fragment13(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const render_changes = dirty & /*$$restProps, propsWeControl, as, slotProps, use, forwardEvents, visible*/
...
function create_fragment27(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const render_changes = dirty & /*$$restProps, $api, as, slotProps, use, forwardEvents, visible*/
...
function create_fragment39(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const render_changes = dirty & /*$$restProps, propsWeControl, as, use, forwardEvents, slotProps, selected*/
